"""Generate a PDF for the Sprint 3 consolidated manager report."""
...
MD_PATH = REPO / "docs" / "sprint3-manager-report-2026-08-21.md"
PDF_PATH = REPO / "docs" / "sprint3-manager-report-2026-08-21.pdf"
...
def on_page(canvas, doc):
    ...
    canvas.drawString(1.8 * cm, h - 0.72 * cm,
                      "TransformED AI — Sprint 3: Consolidated Manager Report")
    canvas.setFont("Helvetica", 8)
    canvas.drawRightString(w - 1.8 * cm, h - 0.72 * cm, "2026-08-21")
...
def build_pdf(md_path: Path, pdf_path: Path):
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=1.8 * cm,
        bottomMargin=1.4 * cm,
        title="Sprint 3 — Consolidated Manager Report",
        ...
        if line.startswith("|"):
            ...
            if rows:
                ...
                if n_cols == 2:
                    ...
                    cw = [pw * 0.13, pw * 0.37, pw * 0.22, pw * 0.28]
                elif n_cols == 5:

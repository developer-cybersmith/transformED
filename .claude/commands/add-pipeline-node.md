...
Add a new node to the HIE LangGraph content generation pipeline.
...
## Pipeline order reference (PRD Â§9)
```
extract â†’ structure â†’ chunk â†’ embed â†’
lesson_planner â†’ slide_generator â†’ summarise_segment â†’ quiz_generator â†’
segment_complexity â†’ jargon_extractor â†’ intervention_messages â†’
narration_generator â†’ tts_node â†’ image_generator â†’ package_builder
```

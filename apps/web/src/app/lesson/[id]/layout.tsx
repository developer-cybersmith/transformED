...
export default function LessonLayout({
    ...
    return (
        <div className="w-full bg-primary-dark min-h-screen text-slate-50 selection:bg-[var(--accent-secondary)]/30 selection:text-white flex flex-col font-sans overflow-hidden">

...
export const AuroraBackground = ({
    ...
    return (
        ...
        >
          ...
          [--aurora:repeating-linear-gradient(100deg,var(--color-blue-200)_10%,var(--color-blue-300)_15%,var(--color-blue-100)_20%,var(--color-sky-200)_25%,var(--color-blue-200)_30%)]

        ...
        return (
            <motion.button
                ...
                className={cn(
                    ...
                    {
                        "bg-gradient-to-r from-[var(--accent-primary)] to-[var(--accent-secondary)] text-white shadow-lg shadow-[var(--accent-primary)]/20 hover:shadow-[var(--accent-primary)]/40": variant === "primary",

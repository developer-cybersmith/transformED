        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center space-x-2 mt-2">
                    <input
                        ...
                        id="remember"
                        name="remember"
                        className="w-4 h-4 rounded border-neutral-300 text-[var(--accent-primary)] focus:ring-[var(--accent-primary)] focus:ring-offset-0"
                    />
                    <Label htmlFor="remember" className="text-sm font-normal text-neutral-600 cursor-pointer">
                        Remember me
                    </Label>
                </div>
            ...
            <div className="mt-8 mb-8 relative">
                ...
                <div className="relative flex justify-center text-sm">
                    <span className="px-4 bg-white text-neutral-500 text-xs font-medium uppercase tracking-wider">
                        Or continue with
                    </span>
                </div>
            </div>

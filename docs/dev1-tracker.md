...
- [ ] **S4-6 Fly.io backups + disaster recovery tested** — renamed from "Railway backups" 2026-09-05 (D164); Railway was retired 2026-08-14, platform is Fly.io + Upstash Redis. DR work itself is still not started.

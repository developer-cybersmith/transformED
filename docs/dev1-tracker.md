...
**Story 3-35 — env/config correctness, 2026-08-11 (branch `sprint3/s3-35-env-config-fixes`, PR
not yet opened).** Bundled fix for D62 + D31 (High, live in prod) + D48. Full details in that
branch's own `docs/dev1-tracker.md` edit — not repeated here since this branch forked from
`main` before 3-35 merged; see the story file `docs/stories/3-35-env-config-fixes.md`.
...
- [x] **S3-37 Langfuse instrumentation audit (env, session semantics, naming)** — ✓ 2026-08-12

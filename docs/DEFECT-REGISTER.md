...
| **Open** | **11** |
| Of which **live in production** | **2** — D29 (DPDP consent row, Dev 3), **D31** (env prefix, Dev 1). D18/D35 closed 2026-08-04 (PR #119 + Story 2-39, both verified on `main`). | 
...
| Open entries with a named owner **and** a trigger | **10 of 11** (D36 has no owner) |

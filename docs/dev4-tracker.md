...
**Last updated:** 2026-08-31 (BR-1 `generation_progress` pub/sub transport shipped and Completed, merged via PR #162; BR-2 CES/intervention-timing verification closed — audit found no bug, added regression-lock tests)

...
| Bug Resolution (Feature Sprint 2) | Post-Sprint 4 | 6 (BR-1 through BR-6) | **1** | 0 | **5** |
| Launch | Week 10 | 5 | 0 | 0 | **5** |
| **Total** | **10 weeks + Bug Resolution** | **66** | **42** | **1** | **23** |
...
Started immediately after Sprint 4 on per-dev integration branches (e.g. Dev 4's `dev4/master-bug-resolution`), rather than waiting for a full Sprint 4 close-out. 6 tasks below, as assigned to Dev 2.

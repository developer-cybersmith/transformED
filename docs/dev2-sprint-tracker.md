...
| Bug Resolution (Feature Sprint 2) | Post-Sprint 4 | 7 (BR-1 through BR-6, +1 ad-hoc: BR-7) | **1** | 0 | **6** |
| Launch | Week 10 | 5 | 0 | 0 | **5** |
| **Total** | **10 weeks + Bug Resolution** | **67** | **43** | **1** | **23** |
...
Add a configurable pause (default 2s) between slide transitions, plus a manual "Next" button for navigation (currently transitions are fully automatic).

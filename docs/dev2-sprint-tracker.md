...
| Bug Resolution (Feature Sprint 2) | Post-Sprint 4 | 8 (BR-1 through BR-6, +2 ad-hoc: BR-7, BR-8) | **3** | 0 | **5** |
| Launch | Week 10 | 5 | 0 | 0 | **5** |
| **Total** | **10 weeks + Bug Resolution** | **68** | **45** | **1** | **22** |
...
Update `ModeSelection.tsx`'s tier cards to show explicit "15 min / 30 min / 45 min" labels instead of (or alongside) the existing tier names. Depends on Dev 3 confirming the tier→minute mapping (their own BR list: "verify T3=15, T2=30, T1=45").
